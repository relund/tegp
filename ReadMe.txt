Read me file for the TEGP distribution
======================================

    Version 1.66 - July 2013

    Copyright (C) 2013 Lars Relund Nielsen
    ...
    You can contact me at: lars@relund.dk
...
===============================================================================
  ...
  This distribution contains an implementation of the TEGP generator for
  generating stochastic time-dependent networks. For more details see the
...
===============================================================================
  ...
  You should find in this distribution the following files and folders:
     ...
     doc folder           - Documentation (see this folder for an introduction).
     source folder        - The source code.

3. How to run TEGP
===============================================================================

  Binaries for TEGP are given in the 'binaries' folder for both Linux and
  ...
  For details on how to run TEGP see the documentation (doc folder). To test
  ...
  should be produced 'run.log' and 'test_stdn.xml'.


4. How to compile TEGP
===============================================================================
  ...
  installed libxml2 and iconv on your system. I have used libxml2 (v2.6.19),
  iconv (v1.9.1) and zlib (v1.2.2). Higher versions should properly also work
  but I have not tested it. Binaries/source for both Linux and Windows can be
  downloaded from ftp://xmlsoft.org/libxml2/. For more details see
  http://xmlsoft.org/. Under Windows it may be a good idea to extract the
  binaries/source in the 'code' folder.

  To compile on Linux:

  From the command prompt goto folder 'linux' and run the makefile by writing
  >make. The program tegp should now have been compiled. If you face problems
  ...
  The program can be complied using MS VC++ (v6.0). Goto the 'win' folder and
  open the workspace file 'tegp.dsw'. The files will then be loaded in VC++.
  ...
  Similar the program can be complied using Code::Blocks and load the file in 
  Code::Blocks.
